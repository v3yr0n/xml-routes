/* global XmlRoutes:true */

var Fiber = Npm.require('fibers');
var connect = Npm.require('connect');
var connectRoute = Npm.require('connect-route');
var js2xmlParser = Npm.require('js2xmlparser');
...
// Handler for adding middleware before an endpoint (XmlRoutes.middleWare
// is just for legacy reasons). Also serves as a namespace for middleware
// packages to declare their middleware functions.
XmlRoutes.Middleware = XmlRoutes.middleWare = connect();
WebApp.connectHandlers.use(XmlRoutes.Middleware);
...
XmlRoutes.add = function (method, path, handler) {
...
XmlRoutes.setResponseHeaders = function (headers) {
